...
import { genType, dataCompress } from './csdataprep';
import { csheader } from './csheader';
import './stockdata.csv'
...
export function toSlice(data) { return data.slice(-TDays[TPeriod]); }
...
export function displayGen(mark) {
    var header = csheader();
